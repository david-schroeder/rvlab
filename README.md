...
To generate HTML documentation, run `make html` in the *docs/* directory.

To run the project on your own computer outside of the MSC infrastructure, please follow the setup instructions at *docs/tutorials/setup/index.rst*.
